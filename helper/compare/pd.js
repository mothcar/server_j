...
function pd(aLines, bLines, diffPlusFlag) {
  ...
  // Paul code
  return {paul: paul_result, lines: result, lineCountDeleted: deleted, lineCountInserted: inserted, lineCountMoved:0};
